                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="stock.php"><i class="ti-dashboard"></i><span>Stocks</span></a>
                            </li>
							<li class="active">
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layout"></i><span>Transaction Data
                                    </span></a>
                                <ul class="active">
                                    <li class="active"><a href="masuk.php">Incoming Items</a></li>
                                    <li><a href="keluar.php">Outgoing Items</a></li>
                                </ul>
                            </li>
                            <li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									...
									<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-plus"></span>New Incoming</button>
                                </div>
											...
											while($b=mysqli_fetch_array($brg)){
                                                ...
                                                <div class="modal fade" id="edit<?=$id;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <label for="nama">Product's Name</label>
                                                    ...
                                                    <div class="modal fade" id="del<?=$id;?>">
                                                        ...
                                                        <form method="post">
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                            <h4 class="modal-title">Delete Products <?php echo $b['nama']?> - <?php echo $b['jenis']?> - <?php echo $b['ukuran']?></h4>
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
                                                            
                                                            <!-- Modal body -->
                                                            <div class="modal-body">
                                                            Are you sure you want to remove this item from the incoming stock list?
                                                            <br>
                                                            *Stock items will decrease
                                                            <input type="hidden" name="id" value="<?=$id;?>">
                                                            <input type="hidden" name="idx" value="<?=$idb;?>">
                                                            </div>
	...
	<!-- modal input -->
			<div id="myModal" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">Input Incoming Items</h4>
						</div>
						<div class="modal-body">
							<form action="barang_masuk_act.php" method="post">
								...
								<div class="form-group">
									...
									?>
										<option value="<?php echo $d['idx'] ?>"><?php echo $d['nama'] ?> <?php echo $d['jenis'] ?> <?php echo $d['merk'] ?>, Uk.</option>
										<?php
								}
								?>
									</select>
