                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="stock.php"><i class="ti-dashboard"></i><span>Product Stock</span></a>
                            </li>
							<li class="active">
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layout"></i><span>Transaction Data
                                    </span></a>
                                <ul class="active">
                                    <li><a href="masuk.php">Incoming Items</a></li>
                                    <li class="active"><a href="keluar.php">Outgoing Items</a></li>
                                </ul>
                            </li>
                            <li>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Outgoing Items</span></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									...
									<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-plus"></span>New Outgoing</button>
                                </div>
                                                ...
                                                <div class="modal fade" id="edit<?=$id;?>">
                                                    ...
                                                    <div class="modal fade" id="del<?=$id;?>">
                                                        ...
                                                        <form method="post">
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                            <h4 class="modal-title">Delete Product <?php echo $b['nama']?> - <?php echo $b['jenis']?></h4>
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
                                                            
                                                            <!-- Modal body -->
                                                            <div class="modal-body">
                                                            Are you sure you want to remove this item from the stock list?
                                                            <br>
                                                            *Stock items will increase
                                                            <input type="hidden" name="id" value="<?=$id;?>">
                                                            <input type="hidden" name="idx" value="<?=$idb;?>">
                                                            </div>
	...
	<!-- modal input -->
			<div id="myModal" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">Input Outgoing Items</h4>
						</div>
						<div class="modal-body">
